...
public class OrderDTO {
    ...
    @Expose
    private ArrayList<HashMap<String,String>> variablesList;

    public OrderDTO(String folder, String application, String subapplication, String ctm, String jobs,
    ...
    public String toString() {
        return "OrderDTO [folder=" + folder + ", application=" + application + ", subapplication=" + subapplication
